      ...
      <div className="w-full h-full pb-20">
        <div className="px-4 max-w-7xl m-auto py-30 md:py-0">
          <div className="w-full h-full lg:h-screen flex flex-col justify-center items-center pt-20">
            <div className="w-full flex flex-col gap-y-7 text-center">
              <h1 className="bg-white dark:bg-[#161F33] rounded-full font-bold text-2xl max-w-xl m-auto flex lg:text-3xl/12">
                <span>
              ...
              <p className="bg-white dark:bg-[#161F33] rounded-full text-neutral-500 dark:text-[#B3B8C4] max-w-sm m-auto">
            ...
            <div className="pt-20">
              <div className="space-y-5 text-center">
                <h1 className="bg-white dark:bg-[#161F33] rounded-full text-neutral-500 dark:text-[#B3B8C4] text-lg/9 max-w-2xl mx-auto">
        ...
        <div className="px-4 max-w-7xl m-auto">
          <div className="w-full h-full py-20 space-y-34">
            <div className="w-full flex flex-col text-center">
              ...
              <h1 className="bg-white dark:bg-[#161F33] rounded-full font-bold text-2xl max-w-xl m-auto lg:text-3xl/12">
                Experiences
              </h1>
            </div>
            <div>
        ...
        <div className="px-4 max-w-7xl m-auto">
          <div className="w-full h-full py-20 space-y-34">
            ...
            <div className="bg-white  dark:bg-[#161F33] rounded-full flex flex-1 max-w-3xl m-auto flex-wrap justify-center gap-4">
